...
Thank you for your interest in contributing to **ios-app**! We welcome contributions from the community to help improve the project. Here are some guidelines to help you get started:
...
- **feat**: A new feature (e.g. `feat: add support for sqlite local storage`)
- **fix**: A bug fix (e.g. `fix: correct task creation in <class method>`)
- **perf**: A code change that improves performance (e.g. `perf: optimize point filter for better performace`)
